...
if __name__ == "__main__":
    ...
    best_model_path = "/home/sander/code/thesis/hover/leon/checkpoints/2024-03-14_17-16-50/bestckpt_epoch=2_val_loss=0.19.ckpt"
    batch_size = 32
    data = load_obj("/home/sander/code/thesis/hover/leon/cross_encoder_claim_title_sentence_label_pairs_dev.json")
