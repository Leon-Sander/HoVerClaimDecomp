...
for threshhold in tqdm([5, 10, 20, 60, 80, 125, 300]):
            ...
            if run_count <= int(hop_count):
                ...
                for key in data[hop_count]:
                    ...
                    for i, item in enumerate(data[hop_count][key]):
                        ...
                        sentences_sorted_top20 = sentences_sorted[:threshhold]
    ...
    save_obj(data, f"data/iterative_cross_test_{threshhold}_no_filter.json")
