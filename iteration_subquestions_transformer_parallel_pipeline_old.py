                    ...
                    for k in range(10):
                        ...
                        if idx < len(data[hop_count][key]):
                            try:
                                ...
                                print(f"hop_count: {hop_count}, key: {key}, idx: {idx}, run_count: {run_count}")
                                sys.exit()
...
try:
    ...
    save_obj(data, "data/iterative_FULL_DATASET_with_questions_60_no_filter_RESET_KORRIGIERT.json")


except Exception as e:
    # print traceback
    #save_obj(data, "data/iterative_FULL_DATASET_with_questions_60_no_filter_RESET_KORRIGIERT_ZWISCHENERGEBNIS.json")
