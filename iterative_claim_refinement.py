...
import logging
import traceback
from pipeline_parts import claim_refinement, base_retrieval_for_next_iter, cross_encode_sub_questions, generate_subquestions, subquestion_retrieval, create_top_sentences, create_top_sentences_with_filter
...
if __name__ == "__main__":
    ...
    try:
        for run_count in tqdm(range(0,4), desc='Run Count'):
            ...
            #data = create_top_sentences_with_filter(data, run_count, threshold=60)
        ...
        save_obj(data, "data/iterative_FULL_DATASET_with_questions.json")
        logging.info('Data saved successfully')


    except Exception as e:
        # print traceback
        save_obj(data, "data/iterative_FULL_DATASET_with_questions_ZWISCHENERGEBNIS.json")
